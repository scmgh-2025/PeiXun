              ...
              { 
                ...
                tabs: [
                  ...
                  },
                  {
                    ...
                    audience: "渠道商、供应商",
                    modules: [
                      { name: "角色入驻", content: "支持酒店商户入驻成为渠道商，支持供应商上架商品并推送到供应链平台。" },
                      { name: "商城运营", content: "管理自有商城并售卖平台优质商品，涵盖商品上架、库存同步与监控。" },
                      { name: "全流程履约", content: "打通订单履约全流程，确保自营商品与智能体前台服务无缝对接。" }
                    ]
                  },
                  {
                    title: "供应链管理平台",
